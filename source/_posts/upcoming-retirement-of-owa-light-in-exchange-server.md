...
現在も OWA Light を利用している場合は、標準の Outlook on the web へ移行するとともに、OWA Light について記載されている社内ガイド、ブックマーク、トレーニング資料、ヘルプデスク向けのサポート手順や案内文、アクセシビリティ対応の運用手順を見直す必要があります。
...
OWA Light を今すぐブロックするには、OWA メールボックスポリシーを作成または既存のものを更新します。
