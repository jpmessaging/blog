...
[Exchange Online EWS: 廃止期限が迫っています](/blog/exchange-online-ews-your-time-is-almost-up/) でお知らせしたとおり、Exchange Online の Exchange Web Services (EWS) は 2026 年 10 月から段階的に無効化され、2027 年 4 月に完全に無効化されます。この取り組みの一環として、現在 Exchange Online の EWS エンドポイントに依存している、残りの Exchange Server 組織間コラボレーション シナリオへの対応を進めています。
