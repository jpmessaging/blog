...
- [Log Parser](https://www.microsoft.com/download/details.aspx?id=24659) と [Log Parser Studio](https://techcommunity.microsoft.com/blog/exchange/log-parser-studio-2-0-is-now-available/593266) を使って、独自の SQL クエリを作成する  
*または*
