...
- Microsoft 365 管理センターで [EWS の使用状況レポート](https://learn.microsoft.com/microsoft-365/admin/activity-reports/ews-usage?view=o365-worldwide) を確認し、必要に応じて公開されているスクリプトの使用を検討してください。[現場レポート：EWS 廃止前に行う EWS アプリ利用状況の確認と対策](https://jpmessaging.github.io/blog/notes-from-the-field-finding-and-remediating-ews-app-usage-before-retirement/) を確認してください。
...
変更履歴:
- **2026/3/17**: [現場レポート：EWS 廃止前に行う EWS アプリ利用状況の確認と対策](https://jpmessaging.github.io/blog/notes-from-the-field-finding-and-remediating-ews-app-usage-before-retirement/) へのリンクを追加しました
