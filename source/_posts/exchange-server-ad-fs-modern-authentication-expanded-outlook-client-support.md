...
| --- | --- | --- |
| Outlook for Windows | サポート対象の Microsoft 365 Apps 各チャネルおよび永続ライセンス版<br>Windows 11 バージョン 22H2 以降 | 必要な Windows 更新プログラムをインストールし、AD FS サービスの URL を信頼済みに設定してから、Outlook でオンプレミス Exchange の先進認証を有効にします。 |
