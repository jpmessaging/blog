...
以前のバージョンの Microsfot Entra Connect で「ExchangeManagedAttributesUpdateNotAllowed」エラーが発生していたお客様は、この問題が解決されたバージョン <strong>2.5.190.0</strong> へアップグレードのうえ、クラウド管理のリモート メールボックスの展開を進めてください。
</p>
